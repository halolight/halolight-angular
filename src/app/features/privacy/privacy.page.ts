  ...
  template: `
    <div class="container mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      <article class="prose prose-slate dark:prose-invert max-w-none">
        <h1 class="text-3xl font-bold tracking-tight text-foreground">隐私政策</h1>
        <p class="text-muted-foreground">最后更新日期：2024年1月1日</p>

        <section class="mt-8">
          <h2 class="text-xl font-semibold text-foreground">1. 引言</h2>
        ...
        <section class="mt-8">
          <h2 class="text-xl font-semibold text-foreground">2. 信息收集</h2>
        ...
        <section class="mt-8">
          <h2 class="text-xl font-semibold text-foreground">3. 信息使用</h2>
        ...
        <section class="mt-8">
          <h2 class="text-xl font-semibold text-foreground">4. 信息共享</h2>
          <p class="text-muted-foreground leading-relaxed">
        ...
        <section class="mt-8">
          <h2 class="text-xl font-semibold text-foreground">5. 信息安全</h2>
          <p class="text-muted-foreground leading-relaxed">
        ...
        <section class="mt-8">
          <h2 class="text-xl font-semibold text-foreground">6. 您的权利</h2>
          <p class="text-muted-foreground leading-relaxed">根据适用法律，您享有以下权利：</p>
          <ul class="list-disc pl-6 text-muted-foreground space-y-2">
            <li>访问您的个人信息</li>
            <li>更正不准确的信息</li>
            <li>删除您的个人信息</li>
        ...
        <section class="mt-8">
          <h2 class="text-xl font-semibold text-foreground">7. Cookie 政策</h2>
          <p class="text-muted-foreground leading-relaxed">
            我们使用 Cookie 和类似技术来：
          </p>
          <ul class="list-disc pl-6 text-muted-foreground space-y-2">
        ...
        <section class="mt-8">
          <h2 class="text-xl font-semibold text-foreground">8. 儿童隐私</h2>
          <p class="text-muted-foreground leading-relaxed">
        ...
        <section class="mt-8">
          <h2 class="text-xl font-semibold text-foreground">9. 政策更新</h2>
          <p class="text-muted-foreground leading-relaxed">
        ...
        <section class="mt-8">
          <h2 class="text-xl font-semibold text-foreground">10. 联系我们</h2>
          <p class="text-muted-foreground leading-relaxed">
